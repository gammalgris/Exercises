...
public enum ActivationFunctions implements ActivationFunction {
    ...
    QUADRATIC1(new QuadraticActivationFunction("1", "0.5")),
    QUADRATIC2(new QuadraticActivationFunction("2", "-0.5", "-0.5")),
    QUADRATIC3(new QuadraticActivationFunction("1.5", "-1", "1")),
    /*RECIPROCAL1(new ReciprocalActivationFunction("1", "0.5")),
    RECIPROCAL2(new ReciprocalActivationFunction("2")),
    RECIPROCAL3(new ReciprocalActivationFunction("1.5")),*/ ;
