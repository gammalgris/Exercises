 ...
 *
 *
 * chapter 5 - listing 5.2 - pages 79 to 91
 */
...
class Sample2 implements ExampleChart<XYChart> {
    ...
    static double doublePointNumber = 0D;
    static int intPointNumber = 0;
    static InputStream input = null;
    static int intNumberOfRecordsInTrainFile;
    static double[] arrPrices = new double[2500];
    static double normInputXPointValue = 0.00D;
    static double normPredictXPointValue = 0.00D;
    static double normTargetXPointValue = 0.00D;
    static double normDifferencePerc = 0.00D;
    static double denormInputXPointValue = 0.00D;
    static double denormPredictXPointValue = 0.00D;
    static double denormTargetXPointValue = 0.00D;
    static double valueDifference = 0.00D;
    ...
    public XYChart getChart() {
        ...
        //Create Chart
        Chart = new XYChartBuilder().width(900)
                                    .height(500)
                                    ...
                                    .build();
        // Customize Chart
        //Chart.getStyler().setPlotBackgroundColor(ChartColor.getAWTColor(ChartColor.GREY)); <- ERROR
        Chart.getStyler()
            .setPlotBackgroundColor(Color.GRAY); // replacement for previous line - import statement was missing and class seems to have changed
        ...
        Chart.getStyler().setLegendPosition(LegendPosition.InsideSE); // <- ERROR - import was missing
        ...
        // Set the working mode the program should run (workingMode = 1 - training,
        ...
        try {
            if (workingMode == 1) {
                ...
                trainFileName = ".\\data\\training_data_set_norm.csv";
                ...
                // testFileName = ".\\data\\test_data_set_norm.csv";
                // chartTestFileName = "XYLine_Test_Results_Chart";
            }

            // Common configuration data
            networkFileName = ".\\data\\Sample2_Saved_Network_File.csv";
            ...
            System.err.println("Problem parsing workingMode. working Mode = " + workingMode);
            System.exit(1);
        } catch (Throwable t) {
            t.printStackTrace();
            System.exit(1);
    ...
    static public int trainValidateSaveNetwork() {
        ...
        try {
            ...
            BitmapEncoder.saveBitmapWithDPI(Chart, chartTrainFileName, BitmapFormat.JPG,
    ...
    static public void loadAndTestNetwork() {
        ...
        // Load and test dataset into memory

        MLDataSet testingSet =
            loadCSV2Memory(testFileName, numberOfInputNeurons, numberOfOutputNeurons, true, CSVFormat.ENGLISH, false);
        ...
        for (MLDataPair pair : testingSet) {
            ...
            // These value are normalized as the whole input is
            ...
            denormInputXPointValue =
                ((minXPointDl - maxXPointDh) * normInputXPointValueFromRecord - Nh * minXPointDl + maxXPointDh * Nl) /
                (Nl - Nh);

            denormTargetXPointValue =
                ((minTargetValueDl - maxTargetValueDh) * normTargetXPointValueFromRecord - Nh * minTargetValueDl +
                 maxTargetValueDh * Nl) / (Nl - Nh);

            denormPredictXPointValue =
                ((minTargetValueDl - maxTargetValueDh) * normPredictXPointValueFromRecord - Nh * minTargetValueDl +
                 maxTargetValueDh * Nl) / (Nl - Nh);

            targetToPredictPercent =
                Math.abs((denormTargetXPointValue - denormPredictXPointValue) / denormTargetXPointValue * 100);

            System.out.println("xPoint = " + denormInputXPointValue + "  denormTargetXPointValue = " +
                               denormTargetXPointValue + "  denormPreictXPointValue = " + denormPredictXPointValue +
        ...
        System.out.println("End of testing fortesrt records");
    } // End of the method

    @Override
    public String getExampleChartName() {

        return "Network Prcessing Program Code";
    }
