...
import static jmul.neural.neurons.NetworkHelper.activateNetwork;
...
public class TrainingTest {
    ...
    static {
        ...
        NETWORK_CONFIGURATION = new int[] { 1, 3, 3, 1 };
    }
    ...
    public static void main(String... args) {
        ...
        deactivate(fittestIndividuals);

        System.out.println("done.");
    }

    private static void activate(Population<Network> population) {

        int max = population.getSize();

        for (int index = 0; index < max; index++) {

            Network network = population.getIndividual(index);
            activateNetwork(network);
        }
    }

    private static void deactivate(Population<Network> population) {
