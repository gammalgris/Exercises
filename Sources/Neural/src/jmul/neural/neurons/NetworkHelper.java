...
public final class NetworkHelper {
    ...
    public static void setBias(Neuron neuron, Number bias) {
        ...
        if (neuron instanceof ConcurrentNeuronImpl) {

            ConcurrentNeuronImpl neuron2 = (ConcurrentNeuronImpl) neuron;
     ...
     */
    public static void setActivationFunction(Neuron neuron, ActivationFunction activationFunction) {
    ...
    public static void linkNeurons(Neuron neuronFrom, Synapse synapse, Neuron neuronTo) {
        ...
        if ((neuronFrom instanceof ConcurrentNeuronImpl) && (neuronTo instanceof ConcurrentNeuronImpl)) {

            ConcurrentNeuronImpl neuronFrom2 = (ConcurrentNeuronImpl) neuronFrom;
            ConcurrentNeuronImpl neuronTo2 = (ConcurrentNeuronImpl) neuronTo;

            neuronFrom2.addSignalDestination(synapse);
            neuronTo2.addSignalSource(synapse);
    ...
    public static void linkInputNeuron(Synapse synapse, Neuron neuronTo) {
        ...
        if (neuronTo instanceof ConcurrentNeuronImpl) {
    ...
    public static void linkOutputNeuron(Neuron neuronFrom, Synapse synapse) {
        ...
        if (neuronFrom instanceof ConcurrentNeuronImpl) {
    ...
    /**
     * Activates the specified network of neurons.
     *
     * @param network
     *        a network of neurons
     */
    public static void activateNetwork(Network network) {
        ...
        for (Neuron neuron : network.neurons()) {
            ...
            Thread thread = new Thread(neuron);
            threads.add(thread);
        }
    ...
    private static FlatNetworkImpl clone(FlatNetworkImpl network) {
...

        {
            ...
            for (int index = 0; index < max; index++) {
                ...
                ActivationFunction activationFunction = original.activationFunction();
